...
// grabs the id's and sets variables as written
...
// to create a new startscreen class for startscreen file
    const startScreen = new StartScreen(ctx, canvas);
    const game = new Game(canvas, ctx, page, input);

    // game.testThis();

// this is the title drops screen once you load the page
    //start-screen
